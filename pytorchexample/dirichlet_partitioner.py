...
class DirichletPartitioner(Partitioner):
    ...
    # NOTE: This function has been modified to return indices not datasets
    def load_partition(self, partition_id: int) -> list[int]:
        ...
        Returns
        -------
        _partition_id_to_indices[partition_id]: list[int] 
        ...
        return self._partition_id_to_indices[partition_id]
